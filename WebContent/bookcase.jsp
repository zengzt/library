...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('bookCase.do?action=bookCaseModifyQuery&ID=<%=ID%>','','width=292,height=175')">修改</a></td>
    <td align="center"><a href="bookCase.do?action=bookCaseDel&ID=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
